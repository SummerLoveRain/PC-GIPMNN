...
if __name__ == "__main__":
    ...
    for i in range((GRID_SIZE+1)*(GRID_SIZE+1)):
        ...
        if (((y <= 70)and(x <= 170)) or ((y <= 110)and(x <= 150)) or ((y <= 130)and(x <= 130)) or ((y <= 150)and(x <= 110)) or ((y <= 170)and(x <= 70))):
            ...
            if (y==10 and x>0 and x<10):
            ...
            elif (y==70 and x>0 and x<10):
                x_35.append([x])
                y_35.append([y])
                n_35.append([0, -1])
            elif (y==90 and x>0 and x<10):
                x_35.append([x])
                y_35.append([y])
                n_35.append([0, 1])
                ...
                or ((x>70)and(x<90)and(y>70)and(y<90))\
                or ((x>0)and(x<10)and(y>70)and(y<90)):
                    ...
                    num_3 = num_3 + 1
                elif ((x>0)and(x<=30)and(y>130)and(y<150))\
                or ((x>30)and(x<50)and(y>110)and(y<150))\
                or ((x>=50)and(x<90)and(y>110)and(y<130))\
                or ((x>70)and(x<=90)and(y>90)and(y<=110))\
                or ((x>90)and(x<110)and(y>70)and(y<110))\
                or ((x>=110)and(x<130)and(y>=70)and(y<90))\
                or ((x>110)and(x<130)and(y>30)and(y<70))\
                or ((x>=130)and(x<150)and(y>=30)and(y<50))\
                or ((x>130)and(x<150)and(y>0)and(y<30)):
                    ...
                    num_1 = num_1 + 1
                elif ((x>0 and x<=50)and(y>150 and y<170))\
                or ((x>50 and x<70)and(y>130 and y<170))\
                or((x>=70 and x<110)and(y>130 and y<150))\
                or ((x>90 and x<=110)and(y>110 and y<=130))\
                or ((x>110 and x<130)and(y>90 and y<130))\
                or ((x>=130 and x<150)and(y>=90 and y<110))\
                or ((x>130 and x<150)and(y>50 and y<90))\
                or ((x>=150 and x<170) and (y>=50 and y<70))\
                or ((x>150 and x<170) and (y>0 and y<50)):
                    ...
                    num_4 = num_4 + 1
                elif (x>0 and x<=10 and y>10 and y<70)\
                or (x>0 and x<=10 and y>90 and y<130)\
                or (x>10 and x<30 and y>0 and y<130)\
                or (x>=30 and x<70 and y>0 and y<110)\
                or (x>=70 and x<=90 and y>10 and y<70)\
                or (x>90 and x<110 and y>0 and y<70)\
                or (x>=110 and x<130 and y>0 and y<30):
